  ...
  if (bids.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <p className="font-medium text-gray-500 mb-1">暂无报价</p>
        <p className="text-sm text-gray-400">司机收到通知后会尽快报价，请稍候</p>
      </div>
    )
  }
        ...
        {bids.map(bid => (
          ...
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 text-xs text-gray-500 mt-0.5">
                    ...
                    <span>·</span>
                    <span>{bid.driver?.total_trips ?? 0} 次行程</span>
            ...
            <div className="text-sm text-gray-600 bg-gray-50 rounded-lg px-3 py-2 mb-3">
              <span className="font-medium">车型：</span>{bid.vehicle_info}
            </div>
